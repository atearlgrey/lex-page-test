...
const requestDemoApi = Cypress.env('LEX_REQUEST_DEMO_API') || '**/api/request-demo*';
...
Cypress.Commands.add('proxyRequestDemo', () => {
  cy.intercept('POST', requestDemoApi).as('proxyRequestDemo');
});